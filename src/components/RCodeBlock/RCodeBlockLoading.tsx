...
export const RCodeBlockLoading: React.FC<RCodeBlockLoadingProps> = ({ progress, message }) => {
  return (
    <div
      className="p-6 rounded-xl bg-neutral-100 dark:bg-zinc-900 border border-neutral-400/30
    ...
    >
      ...
      <div className="mt-2 text-xs text-neutral-500 dark:text-zinc-500">{progress > 0 ? `${progress}%` : ""}</div>
    </div>
  );
};
